...
describe "the BehaviourFactory" do
  it "should return a ModelBehaviour when given :behaviour_type => :model" do
    ...
    }.should be_an_instance_of(Spec::Merb::DSL::ModelBehaviour)
  end
...
#    }.should be_an_instance_of(Spec::Merb::DSL::ViewBehaviour)
#  end
#
...
#    }.should be_an_instance_of(Spec::Merb::DSL::HelperBehaviour)
#  end
#
...
#    }.should be_an_instance_of(Spec::Merb::DSL::ControllerBehaviour)
#  end
#
