#Spec::DSL::BehaviourFactory.add_behaviour_class(:view, Spec::Merb::DSL::ViewBehaviour)
#Spec::DSL::BehaviourFactory.add_behaviour_class(:helper, Spec::Merb::DSL::HelperBehaviour)
Spec::DSL::BehaviourFactory.add_behaviour_class(:controller, Spec::Merb::DSL::ControllerBehaviour)
Spec::DSL::BehaviourFactory.add_behaviour_class(:model, Spec::Merb::DSL::ModelBehaviour)
  ...
  module DSL
    class BehaviourFactory
      ...
      class << self
        ...
        # In the spirit of Merb' convention
